---
name: scaffold-art-icon
description: Generate icon art using OpenArt (default) or DALL-E, informed by the project's UI kit, color system, and style guide.
...
Generate icon art using OpenArt (default) or DALL-E, informed by the project's UI kit, color system, and style guide.
