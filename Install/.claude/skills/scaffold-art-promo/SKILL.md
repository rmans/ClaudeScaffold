---
name: scaffold-art-promo
description: Generate promotional art using OpenArt (default) or DALL-E, informed by the project's style guide and color system.
...
Generate promotional art using OpenArt (default) or DALL-E, informed by the project's style guide and color system.
...
1. Ensure the output directory exists (create if needed). The directory is `scaffold/assets/promo/`.
...
python scaffold/tools/image-gen.py generate \
    ...
    --output "scaffold/assets/promo/<filename>.png" \
...
Append a row to `scaffold/assets/promo/_index.md` in the Files table:
