...
description: Generate UI mockup art using OpenArt (default) or DALL-E, informed by the project's UI kit, style guide, and color system.
...
Generate UI mockup art using OpenArt (default) or DALL-E, informed by the project's UI kit, style guide, and color system.
