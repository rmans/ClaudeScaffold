...
<!-- One sentence: why does this system exist? What fantasy or need does it serve? -->
...
<!-- What other systems feed INTO this one? Describe at the design level (not signals/methods — those belong in interfaces.md). -->
...
<!-- What this system explicitly does NOT own. Prevents scope creep. -->

- ...

## Edge Cases & Player Questions

<!-- Questions a player would naturally ask. Answer them here so the design is unambiguous. -->
...
<!-- How should this system feel to use? What's the feedback language — visual, audio, haptic? What makes it satisfying? -->
